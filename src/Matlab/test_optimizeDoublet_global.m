function [ camera_array, rmse_array, init_ind ] = test_optimizeDoublet_global( )
clear camera
clear camera_array
...
Ndesigns = 25; % save the top Ndesigns
            ...
            for j4 = 1:5
                for j5 = 1:5
                    for j6 = 1:5
                        ...
                        x = [c1(j1) c2(j2) c3(j3) d1(j4) d2(j5) d3(j6)];
...
for k = 1:Ndesigns
    ...
    x0 = [c1(j1) c2(j2) c3(j3) d1(j4) d2(j5) d3(j6)];
