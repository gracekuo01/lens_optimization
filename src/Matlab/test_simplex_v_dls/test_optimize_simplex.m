function [ camera_array, rmse_array ] = test_optimize_simplex( corr )
clear camera
clear camera_array
...
h = subplot(2,2,3);
viz_camera(camera_array, h); title('Final Design: Simplex')
h = subplot(2,2,4); viz_spotdiag(camera_array, 60, 60, 1000,[], h);
title(['Final RMSE: ' num2str((rmse_array)*1000) ' um']);
